...
{
    /// <summary>
    /// Here implements an experiment that demonstrates how to learn sequences.
    /// </summary>
    ...
    public class SequenceLearning
    {
        public void Run()
        {
            ...
            // It's not stable with 2048 cols 25 cells per column and 0.02 * numColumns synapses on segment.
